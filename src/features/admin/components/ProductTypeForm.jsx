  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm z-[110] px-4">
      <div className="bg-white w-full max-w-md rounded-xl shadow-2xl p-6 relative">
        ...
        <h2 className="text-xl font-bold text-gray-800 mb-6 border-b pb-3">Create Product Type</h2>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-sm font-medium text-gray-700 block mb-1.5">Type Name *</label>
            <input
              name="name"
              value={formData.name}
          ...
          <div>
            ...
            <input
              ...
              placeholder="E.g. short-sleeve-tshirt"
              required
            />
