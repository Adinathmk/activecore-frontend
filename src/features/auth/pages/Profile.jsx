        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-gray-500 mb-8 max-w-sm">
              Please log in or create an account to view and manage your profile details, shipping addresses, and personal order history.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <Link
                to="/login"
                className="px-8 py-3 bg-gray-900 text-white font-medium rounded-xl hover:bg-black transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5"
              >
                Log In
              </Link>
              <Link
                to="/signup"
                className="px-8 py-3 bg-white text-gray-900 font-medium rounded-xl border-2 border-gray-200 hover:border-gray-900 hover:bg-gray-50 transition-all shadow-sm"
              >
                Sign Up
              </Link>
            </div>
